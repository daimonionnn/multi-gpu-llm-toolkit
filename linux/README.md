...
| `start-qwen38-flash-next-q8-nvidia-cpu.sh` | Qwen3.8-Flash-Next Q8_0, 175 GB — CUDA-only + RAM, 128k, **vision on** (`--no-vision` to skip). Needs `runtime-cuda128`, not the dual runtime | — |
